...
def run_model(list_of_contents):
    if list_of_contents is not None:
        ...
        # label = "hello"
        # add_bbox(
        #         fig, 738.58527, 106.9941, 919.34094, 552.2246,
        #         # fig, x0, y0, x1, y1,
        #         opacity=0.7, group=label, name=label, color=COLORS[1],
        ...
        for bbox in myList:
            ...
            x1 = (bbox["boundingBox"]["left"] + bbox["boundingBox"]["width"]) * img_height
            y1 = (bbox["boundingBox"]["top"] + bbox["boundingBox"]["height"]) * img_height
            text = bbox["tagName"]
            label = bbox["tagName"]
